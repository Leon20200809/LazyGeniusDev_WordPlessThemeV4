...
$works_items = [
    ...
    [
        'title' => 'LG UI KIT',
        'text' => 'ハンバーガーメニュー、アコーディオン、タブ切り替えなど、Web制作でよく使うUI部品をまとめ、自作WordPressテーマにも組み込んでいるJavaScript UIキットです。',
        'tech' => 'HTML / CSS / JavaScript',
        'point' => 'data属性やaria属性を使い、HTML・CSS・JavaScriptの責務を分けながら、自作テーマ内でも再利用できるUI部品として整理。',
        'image' => 'works-sample.webp',
        'category' => 'react',
        'url' => $git_hub_url,
    ],
    [
        ...
        'point' => '手動確認に頼らず、テストコードで仕様を確認できる状態を目指し、Featureテスト・Unitテストの基礎を段階的に習得。',
        'image' => 'works-sample.webp',
        'category' => 'laravel',
        'url' => $git_hub_url,
    ],
